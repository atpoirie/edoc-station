...
<div id="inner_container">
    <p style="font-size:12px;"><a href="/unet/copycenter/newjob.php">Home</a> >> Perfect Bind</p>
...
<?php echo (isset($aJob->dueDate) ? 'Value="' . $aJob->dueDate . '"' : 'Value=""') ?>/>
            ...
            <span id="optional">
                Small:<input name="documentsize" style="width:25px;" type="radio" value="Small" id="documentsize" onchange="document_size()"
                             <? echo (isset($aJob->docSize) && $aJob->docSize == 'Small' ? "checked" : "") ?>/>  
                Medium:<input name="documentsize" style="width:25px;" type="radio" value="Medium" id="documentsize" onchange="document_size()"
                              <? echo (isset($aJob->docSize) && $aJob->docSize == 'Medium' ? "checked" : ""); 
                                  echo (!isset($aJob->docSize) ? "checked" : ""); ?>/>  
                Large:<input name="documentsize" style="width:25px;" type="radio" value="Large" id="documentsize" onchange="document_size()"
                             <? echo (isset($aJob->docSize) && $aJob->docSize == 'Large' ? "checked" : "") ?>/>
            </span>
            <br>
            <br>
            ...
            <a id="templatesize" href="templates/Medium.pub">Medium</a>
            <br>
            <br>
