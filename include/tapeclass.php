 ...
 * @author atpoirie
 */
class Tape extends Job {
    public $earliest;
    public $cutting;
    public $bindColor = 'Black';
    public $frontPlastic;
    ...
    function store_job() {
        ...
        if (isset($this->jobId) && $this->jobId != NULL) {
            ...
            $insertPress .= "(id, cutting, bindcolor, frontplastic, frontpresentation, ";
            ...
            $insertPress .= "'$this->frontPlastic', '$this->frontPresentation', ";
    ...
    function update_job() {
        ...
        if (isset($this->jobId) && $this->jobId != NULL) {
            ...
            $updatePress .= "frontplastic = '$this->frontPlastic', ";
    ...
    function email_job() {
        include_once("templates/tape_email.php");
    ...
    function view_job() {
        include_once("./templates/tape_view.php");
        $this->view = $msg;
    }
    ...
    public function calculate_cost() {
        ...
        if($this->departmentCharge != 'Personal Copies') {
            ...
            if ($this->pageCount <= 125)
                $runningTotal += 1.25 * $this->quantity;
            elseif ($this->pageCount <= 250)
                $runningTotal += 1.5 * $this->quantity;
            else
                $runningTotal += 1.75 * $this->quantity;
