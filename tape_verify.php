...
if (!isset($_SESSION['Tape']) || (time() - $_SESSION['Tape']) > (60*60)) {
 
   header('Location: /unet/copycenter/tape.php?session=invalid');
...
if (isset($_POST['submitdate'])) {
   ...
   header('Location: /unet/copycenter/tape.php?submitdate=blank');
...
if (isset($_POST['phone'])) {
   ...
   header('Location: /unet/copycenter/tape.php?phone=blank');
...
if (isset($_POST['jobname'])) {
   ...
   header('Location: /unet/copycenter/tape.php?jobname=blank');
...
if (isset($_POST['departmentcharge'])) {
   ...
   header('Location: /unet/copycenter/tape.php?departmentcharge=blank');
...
elseif ($_COOKIE['Tape']) {
   ...
   header('Location: /unet/copycenter/tape.php?file=blank');
...
if (isset($_POST['pagecount'])) {
   ...
   header('Location: /unet/copycenter/tape.php?pagecount=blank');
...
if (isset($_POST['quantity'])) {
   ...
   header('Location: /unet/copycenter/tape.php?quantity=blank');
...
if (isset($_POST['date1x'])) {
   ...
   header('Location: /unet/copycenter/tape.php?date=blank');
...
if (isset($_POST['transport'])) {
   ...
   header('Location: /unet/copycenter/tape.php?transport=blank');
...
if (isset($_POST['papertype'])) {
   ...
   header('Location: /unet/copycenter/tape.php?papertype=blank');
...
if (isset($_POST['papercolor'])) {
   ...
   header('Location: /unet/copycenter/tape.php?papercolor=blank');
...
if (isset($_POST['coverpapertype'])) {
   ...
   //header('Location: /unet/copycenter/tape.php?coverpapertype=blank');
...
if (isset($_POST['coverpapercolor'])) {
  ...
  // header('Location: /unet/copycenter/tape.php?coverpapercolor=blank');
...
//   header('Location: /unet/copycenter/tape.php?backpapertype=blank');
 
//}
if (isset($_POST['backpapercolor'])) {
    $aJob->backPaperColor = $_POST['backpapercolor'];
}//else {
 //  header('Location: /unet/copycenter/tape.php?backpapercolor=blank');
//}
...
setcookie('Tape', $aJob->serial, $time);
include_once("include/header.php");
?>
...
<div id="inner_container">
    ...
    <p style="font-size:12px;"><a href="<?echo ($aJob->isAdmin) ? 'admin.php">Admin' :'index.php">Home' ?></a> >> <a href="tape.php">Tape Bind</a> >> Tape Bind Confirmation</p>
    <div>
        ...
        <? } ?>
           ...
           <span id="seperator"></span>
            ...
            <form method="post" action="index.php">
                <input type="hidden" name="newjob" value="Tape"/>
            <button type="submit" value="Tape" name="order">Place Order</button>
            <br/>
        </FORM>
