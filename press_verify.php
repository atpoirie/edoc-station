...
if (!isset($_SESSION['Press']) || (time() - $_SESSION['Press']) > (60*60)) {
 
   header('Location: /unet/copycenter/press.php?session=invalid');
...
if (isset($_POST['submitdate'])) {
   ...
   header('Location: /unet/copycenter/press.php?submitdate=blank');
...
if (isset($_POST['phone'])) {
   ...
   header('Location: /unet/copycenter/press.php?phone=blank');
...
if (isset($_POST['jobname'])) {
   ...
   header('Location: /unet/copycenter/press.php?jobname=blank');
...
if (isset($_POST['departmentcharge'])) {
   ...
   header('Location: /unet/copycenter/press.php?departmentcharge=blank');
...
elseif ($_COOKIE['Press']) {
    $temp = unserialize($_COOKIE['Press']);
   ...
   header('Location: /unet/copycenter/press.php?file=blank');
...
if (isset($_POST['pagecount'])) {
   ...
   header('Location: /unet/copycenter/press.php?pagecount=blank');
...
if (isset($_POST['quantity'])) {
   ...
   header('Location: /unet/copycenter/press.php?quantity=blank');
...
if (isset($_POST['date1x'])) {
   ...
   header('Location: /unet/copycenter/press.php?date=blank');
...
if (isset($_POST['transport'])) {
   ...
   header('Location: /unet/copycenter/press.php?transport=blank');
...
if (isset($_POST['bindside'])) {
   ...
   header('Location: /unet/copycenter/press.php?bindside=blank');
...
if (isset($_POST['bindcolor'])) {
   ...
   header('Location: /unet/copycenter/press.php?bindcolor=blank');
...
if (isset($_POST['papertype'])) {
   ...
   header('Location: /unet/copycenter/press.php?papertype=blank');
...
if (isset($_POST['papercolor'])) {
   ...
   header('Location: /unet/copycenter/press.php?papercolor=blank');
...
//   header('Location: /unet/copycenter/press.php?coverpapertype=blank'); 
//}
if (isset($_POST['coverpapercolor'])) {
    $aJob->frontPaperColor = $_POST['coverpapercolor'];
}// else {
   //header('Location: /unet/copycenter/press.php?coverpapercolor=blank'); 
//}
...
if (isset($_POST['backpapertype'])) {
 ...
 //  header('Location: /unet/copycenter/press.php?backpapertype=blank'); 
//}
if (isset($_POST['backpapercolor'])) {
    $aJob->backPaperColor = $_POST['backpapercolor'];
}//else {
//   header('Location: /unet/copycenter/press.php?backpapercolor=blank');
//}
...
setcookie('Press', $aJob->serial, $time);
include_once("include/header.php");
?>
...
<div id="inner_container">
    ...
    <p style="font-size:12px;"><a href="<?echo ($aJob->isAdmin) ? 'admin.php">Admin' :'index.php">Home' ?></a> >> <a href="press.php">Press Bind</a> >> Press Bind Confirmation</p>
    <div>
        ...
        <? } ?>
           ...
           <span id="seperator"></span>
            ...
            <form method="post" action="index.php">
                <input type="hidden" name="newjob" value="Press"/>
