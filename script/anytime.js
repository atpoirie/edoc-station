/*****************************************************************************
 *  THIS VERSION HAS BEEN MODIFIED BY Andy Poirier - NCU
 *  We "disable" weekends and non-business hours
 *  Search for "NCU HACK" to find modified lines
 *  
 *  
      ...
      var mo;
		        	  ...
		        	  if ( dow - _this.fDOW < 7 )
		        	  {
				          ...
				          else
				          {
				            ...
				            td.AnyTime_current( i == current,
					        		((!_this.earliest)||(cmpHi.getTime()>=_this.earliest)) &&
					        		((!_this.latest)||(cmpLo.getTime()<=_this.latest)) &&
									( (dow - _this.fDOW) < 5 ) ); //NCU HACK TO DISABLE WEEKENDS
        ...
        var hr = this.time.getHours();
            ...
            $(this).AnyTime_current( hr == i,
		        	((!_this.earliest)||(cmpHi.getTime()>=_this.earliest)) &&
		        		((!_this.latest)||(cmpLo.getTime()<=_this.latest)) &&
						( i > 8 ) && ( i < 17) );  //NCU HACK TO DISABLE BEFORE 8 AM AND AFTER 4 PM
            if ( i < 23 )
