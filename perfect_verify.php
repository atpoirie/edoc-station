...
<div id="inner_container">
    ...
    <p style="font-size:12px;"><a href="<?echo ($aJob->isAdmin) ? 'admin.php">Admin' :'index.php">Home' ?></a> >> <a href="perfect.php">Perfect Bind</a> >> Perfect Bind Confirmation</p>
    <div>
