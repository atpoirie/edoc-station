...
<div id="inner_container">
    <p style="font-size:12px;"><a href="<?echo ($aJob->isAdmin) ? 'admin.php">Admin' :'index.php">Home' ?></a> >> Press Bind
                                  <? echo $edit ? '>> Job: '.$aJob->jobId : ''?></p>
    <div><form method="post" action="press.php"><button id="clear" type="submit" value="reset" name="clear">Clear</button></form>
        <form name="aForm" id="aForm" method="post" action="press_verify.php" enctype="multipart/form-data">
